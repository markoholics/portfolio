...
export const metadata: Metadata = {
  title: "About",
  description:
    "Markoholics is a GTM and growth strategy practice built for technology companies that intend to win their category — not chase impressions.",
};
      ...
      <section className="container-edge pb-24">
        <Reveal>
          ...
          <p className="text-grey text-lg max-w-2xl mt-8">
            Markoholics was built on a simple premise: the firms running
            campaigns should be the same firms that designed the strategy.
            We work as an embedded growth team for technology companies that
            need to move fast without burning the brand they&apos;re building.
          </p>
        </Reveal>
      </section>
          ...
          <div className="col-span-12 lg:col-span-5">
            <Reveal>
              ...
              <h2 className="font-display text-white text-3xl md:text-4xl leading-tight">
                Category leaders aren&apos;t built on tactics. They&apos;re
                built on systems.
              </h2>
            </Reveal>
          </div>
          <div className="col-span-12 lg:col-span-6 lg:col-start-7 mt-10 lg:mt-0 space-y-6">
            <Reveal delay={0.1}>
              <p className="text-grey text-lg">
                ...
                paid acquisition that respects unit economics, and demand
                generation that sales actually trusts.
              </p>
            </Reveal>
            <Reveal delay={0.18}>
              <p className="text-grey text-lg">
                That only works when one team owns the whole motion. So
                that&apos;s how we&apos;re structured — strategists who stay
                close enough to execution to know what&apos;s actually
                working, and specialists who never lose sight of the plan.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <section className="section-pad border-t hairline text-center">
        <Reveal>
          <h2 className="font-display text-white text-4xl md:text-6xl leading-tight max-w-3xl mx-auto mb-10">
            We work with a small number of companies at a time, by design.
          </h2>
